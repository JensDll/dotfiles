...
class GeneralPurpose(Register):
    ...
    def __init__(
        ...
        self.name32 = GeneralPurpose.MAP32[self.name]
        self.name16 = GeneralPurpose.MAP16[self.name32]
        self.name8h = GeneralPurpose.MAP8H.get(self.name16)
        self.name8l = GeneralPurpose.MAP8L[self.name16]
