...
BRANCH_MAP: dict[str, DoesBranch] = {
    ...
    "jbe": below_equal,
    "jc": carry,
    "jcxz": lambda _, reader: reader.read_gp("cx").value_uint == 0,
    "jecxz": lambda _, reader: reader.read_gp("ecx").value_uint == 0,
    "jrcxz": lambda _, reader: reader.read_gp("rcx").value_uint == 0,
    "je": equal,
    "jg": greater,
    "jge": greater_equal,
    "jl": less,
