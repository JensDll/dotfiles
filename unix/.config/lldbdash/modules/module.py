...
class Module(typing.Protocol):
    ...
    @staticmethod
    def render(size: os.terminal_size, exe_ctx: lldb.SBExecutionContext, stream: Output) -> None: ...


def is_module(obj: object) -> typing.TypeGuard[Module]:
    return inspect.isclass(obj) and callable(getattr(obj, "render", None)) and obj is not Module
